...
UPGRADE_TEXTS = {
    "ru": {
        "title": "⭐ Обновление",
        "choose": "Выбери подписку, чтобы разблокировать больше возможностей.",
        "plus_title": "Mindra+ — комфорт каждый день",
        "plus_bullets": "• Голос с музыкой\n• Больше лимитов\n• Больше звуков сна\n• Сказки средней длины\n",
        "pro_title": "Mindra Pro — максимум без ограничений",
        "pro_bullets": "• Всё из Mindra+\n• Почти без лимитов\n• Длинные сказки\n",
        "pay_title": "Выбери способ оплаты",
        "pay_methods": "Вы можете оплатить через Stripe (карта/ApplePay/GooglePay) или PayPal.",
        "buy": "Купить",
        "back": "⬅️ Назад",
        "open_payment": "Открыть оплату",
        "check_payment": "Я оплатил(а), проверить ✅",
        "pending": "Окей! Если оплата прошла, подписка активируется автоматически в течение пары секунд.\nЕсли не активировалась — нажми “Проверить”.",
        "no_active": "Пока не вижу активной подписки. Если платёж прошёл — подожди минутку и нажми “Проверить” ещё раз.",
        "active_now": "Готово! ✨ Подписка активна.",
    },
    "uk": {
        "title": "⭐ Оновлення",
        "choose": "Виберіть підписку, щоб відкрити більше можливостей.",
        "plus_title": "Mindra+ — комфорт щодня",
        "plus_bullets": "• Голос із музикою\n• Вищі ліміти\n• Більше звуків для сну\n• Історії середньої довжини\n",
        "pro_title": "Mindra Pro — максимум без обмежень",
        "pro_bullets": "• Усе з Mindra+\n• Майже без лімітів\n• Довгі історії\n",
        "pay_title": "Виберіть спосіб оплати",
        "pay_methods": "Можна сплатити через Stripe (картка/ApplePay/GooglePay) або PayPal.",
        "buy": "Купити",
        "back": "⬅️ Назад",
        "open_payment": "Відкрити оплату",
        "check_payment": "Я оплатив(ла), перевірити ✅",
        "pending": "Гаразд! Якщо оплата пройшла, підписка активується автоматично за кілька секунд.\nЯкщо ні — натисніть «Перевірити».",
        "no_active": "Поки не бачу активної підписки. Якщо оплата пройшла — зачекайте хвилину й натисніть «Перевірити» ще раз.",
        "active_now": "Готово! ✨ Підписку активовано.",
    },
    "en": {
        "title": "⭐ Upgrade",
        "choose": "Pick a plan to unlock more features.",
        "plus_title": "Mindra+ — daily comfort",
        "plus_bullets": "• Voice with music\n• Higher limits\n• More sleep sounds\n• Medium-length stories\n",
        "pro_title": "Mindra Pro — maximum freedom",
        "pro_bullets": "• Everything in Mindra+\n• Almost no limits\n• Long stories\n",
        "pay_title": "Choose a payment method",
        "pay_methods": "You can pay via Stripe (card/ApplePay/GooglePay) or PayPal.",
        "buy": "Buy",
        "back": "⬅️ Back",
        "open_payment": "Open payment",
        "check_payment": "I’ve paid, check ✅",
        "pending": "Got it! If the payment succeeded, your subscription will activate automatically within a few seconds.\nIf not — tap “Check”.",
        "no_active": "I don't see an active subscription yet. If you paid — wait a minute and tap “Check” again.",
        "active_now": "Done! ✨ Subscription is active.",
    },
    "md": {  # Romanian (Moldovenească)
        "title": "⭐ Actualizare",
        "choose": "Alege un abonament pentru a debloca mai multe funcții.",
        "plus_title": "Mindra+ — confort zilnic",
        "plus_bullets": "• Voce cu muzică\n• Limite mai mari\n• Mai multe sunete pentru somn\n• Povești de lungime medie\n",
        "pro_title": "Mindra Pro — maxim fără limite",
        "pro_bullets": "• Tot din Mindra+\n• Aproape fără limite\n• Povești lungi\n",
        "pay_title": "Alege metoda de plată",
        "pay_methods": "Plată prin Stripe (card/ApplePay/GooglePay) sau PayPal.",
        "buy": "Cumpără",
        "back": "⬅️ Înapoi",
        "open_payment": "Deschide plata",
        "check_payment": "Am plătit, verifică ✅",
        "pending": "Ok! Dacă plata a reușit, abonamentul se va activa automat în câteva secunde.\nDacă nu — apasă „Verifică”.",
        "no_active": "Încă nu văd un abonament activ. Dacă plata a reușit — așteaptă un minut și apasă din nou „Verifică”.",
        "active_now": "Gata! ✨ Abonamentul este activ.",
    },
    "be": {
        "title": "⭐ Абнаўленне",
        "choose": "Абяры падпіску, каб адкрыць больш магчымасцяў.",
        "plus_title": "Mindra+ — камфорт штодня",
        "plus_bullets": "• Голас з музыкай\n• Больш лімітаў\n• Больш гукаў сну\n• Сярэднія казкі\n",
        "pro_title": "Mindra Pro — максімум без абмежаванняў",
        "pro_bullets": "• Усё з Mindra+\n• Амаль без лімітаў\n• Доўгія казкі\n",
        "pay_title": "Абяры спосаб аплаты",
        "pay_methods": "Можна аплаціць праз Stripe (картка/ApplePay/GooglePay) або PayPal.",
        "buy": "Купіць",
        "back": "⬅️ Назад",
        "open_payment": "Адкрыць аплату",
        "check_payment": "Я аплаціў(ла), праверыць ✅",
        "pending": "Добра! Калі аплата прайшла, падпіска актывуецца аўтаматычна на працягу некалькіх секунд.\nКалі не — націсні «Праверыць».",
        "no_active": "Пакуль не бачу актыўнай падпіскі. Калі аплата прайшла — пачакай хвіліну і націсні «Праверыць» яшчэ раз.",
        "active_now": "Гатова! ✨ Падпіска актываваная.",
    },
    "kk": {
        "title": "⭐ Жаңарту",
        "choose": "Көбірек мүмкіндіктерді ашу үшін жазылымды таңдаңыз.",
        "plus_title": "Mindra+ — күнделікті жайлылық",
        "plus_bullets": "• Әуенмен дауыс\n• Жоғары лимиттер\n• Ұйқы дыбыстары көбірек\n• Орташа ұзындықтағы ертегілер\n",
        "pro_title": "Mindra Pro — шексіз мүмкіндіктер",
        "pro_bullets": "• Mindra+ мүмкіндіктерінің бәрі\n• Дерлік шектеулер жоқ\n• Ұзын ертегілер\n",
        "pay_title": "Төлем тәсілін таңдаңыз",
        "pay_methods": "Stripe (карта/ApplePay/GooglePay) немесе PayPal арқылы төлеуге болады.",
        "buy": "Сатып алу",
        "back": "⬅️ Артқа",
        "open_payment": "Төлемді ашу",
        "check_payment": "Төледім, тексеру ✅",
        "pending": "Жақсы! Төлем сәтті болса, жазылым бірнеше секундта автоматты түрде іске қосылады.\nБолмаса — «Тексеру» түймесін басыңыз.",
        "no_active": "Әзірге белсенді жазылым көрінбейді. Егер төлем жасалды — бір минут күтіп, «Тексеру» түймесін қайта басыңыз.",
        "active_now": "Дайын! ✨ Жазылым белсендірілді.",
    },
    "kg": {
        "title": "⭐ Жаңыртуу",
        "choose": "Көбүрөөк мүмкүнчүлүктөрдү ачуу үчүн жазылууну тандаңыз.",
        "plus_title": "Mindra+ — күнүмдүк ыңгайлуулук",
        "plus_bullets": "• Музыкасы бар үн\n• Жогорку лимиттер\n• Уктатуу үндөрү көбүрөөк\n• Орточо узундуктагы жомоктор\n",
        "pro_title": "Mindra Pro — чектөөсүз максимум",
        "pro_bullets": "• Mindra+’тагынын баары\n• Дээрлик чектөөсүз\n• Узак жомоктор\n",
        "pay_title": "Төлөм ыкмасын тандаңыз",
        "pay_methods": "Stripe (карта/ApplePay/GooglePay) же PayPal аркылуу төлөңүз.",
        "buy": "Сатып алуу",
        "back": "⬅️ Артка",
        "open_payment": "Төлөмдү ачуу",
        "check_payment": "Төлөдүм, текшер ✅",
        "pending": "Макул! Эгер төлөм ийгиликтүү болсо, жазылуу бир нече секундда автоматтык иштетилет.\nБолбосо — «Текшер» баскычын басыңыз.",
        "no_active": "Азырынча активдүү жазылуу жок. Эгер төлөм болсо — бир аз күтүңүз да «Текшер»ди кайра басыңыз.",
        "active_now": "Даяр! ✨ Жазылуу активдүү.",
    },
    "hy": {
        "title": "⭐ Բարձրացում",
        "choose": "Ընտրեք բաժանորդագրություն՝ ավելի շատ հնարավորություններ բացելու համար։",
        "plus_title": "Mindra+ — հարմարավետ ամեն օրը",
        "plus_bullets": "• Ձայն երաժշտությամբ\n• Ավելի մեծ սահմանաչափեր\n• Ավելին՝ քնի ձայներ\n• Միջին երկարության պատմություններ\n",
        "pro_title": "Mindra Pro — առավելագույնը՝ առանց սահմանների",
        "pro_bullets": "• Ամեն ինչ Mindra+-ից\n• Գրեթե առանց սահմանաչափերի\n• Երկար պատմություններ\n",
        "pay_title": "Ընտրեք վճարման եղանակը",
        "pay_methods": "Կարող եք վճարել Stripe-ով (քարտ/ApplePay/GooglePay) կամ PayPal-ով։",
        "buy": "Գնել",
        "back": "⬅️ Վերադառնալ",
        "open_payment": "Բացել վճարումը",
        "check_payment": "Վճարել եմ, ստուգել ✅",
        "pending": "Լավ է։ Եթե վճարումը հաջողվել է, բաժանորդագրությունը կակտիվացվի մի քանի վայրկյանի ընթացքում։\nԵթե ոչ՝ սեղմեք «Ստուգել»:",
        "no_active": "Դեռ ակտիվ բաժանորդագրություն չեմ տեսնում։ Եթե վճարել եք՝ սպասեք մեկ րոպե և նորից սեղմեք «Ստուգել»:",
        "active_now": "Պատրաստ է։ ✨ Բաժանորդագրությունը ակտիվ է։",
    },
    "ka": {
        "title": "⭐ განახლება",
        "choose": "აირჩიეთ გამოწერა მეტი შესაძლებლობებისთვის.",
        "plus_title": "Mindra+ — ყოველდღიური კომფორტი",
        "plus_bullets": "• ხმა მუსიკით\n• უფრო მაღალი ლიმიტები\n• მეტი ძილის ხმები\n• საშუალო სიგრძის ისტორიები\n",
        "pro_title": "Mindra Pro — მაქსიმუმი შეზღუდვების გარეშე",
        "pro_bullets": "• ყველაფერი Mindra+-დან\n• თითქმის ულიმიტო\n• გრძელი ისტორიები\n",
        "pay_title": "აირჩიეთ გადახდის მეთოდი",
        "pay_methods": "გადაიხადეთ Stripe-ით (ბარათი/ApplePay/GooglePay) ან PayPal-ით.",
        "buy": "შეძენა",
        "back": "⬅️ უკან",
        "open_payment": "გადახდის გახსნა",
        "check_payment": "გადახდილია, გადაამოწმე ✅",
        "pending": "კარგი! თუ გადახდა წარმატებულია, გამოწერა ავტომატურად გააქტიურდება რამდენიმე წამში.\nთუ არა — დააჭირეთ „გადაამოწმე“.",
        "no_active": "ჯერ აქტიურ გამოწერას ვერ ვხედავ. თუ გადაიხადეთ — მოიცადეთ ერთი წუთი და ისევ დააჭირეთ „გადაამოწმე“.",
        "active_now": "მზადაა! ✨ გამოწერა აქტიურია.",
    },
    "ce": {
        # для чеченского используем нейтрально-простые формулировки (при желании потом уточним с носителем)
        "title": "⭐ Обновление",
        "choose": "Тахкоча хьо план, тхьа де из йоьлла функцеш.",
        "plus_title": "Mindra+ — кхуьн беш ян",
        "plus_bullets": "• Хьо цхьан зудаш йоь ду музыка\n• Дехар йолу лимиташ\n• Дерриг йоьлла изар хьогIам\n• Чуьра длинна историяш\n",
        "pro_title": "Mindra Pro — йолу била йоцу",
        "pro_bullets": "• Схийла йоьлла Mindra+\n• Дахар до дика хила\n• Бехк дӀаязде историяш\n",
        "pay_title": "ТӀетоха догӀоьш ю",
        "pay_methods": "Stripe (карта/ApplePay/GooglePay) ваьлла, йу PayPal.",
        "buy": "Кхетам",
        "back": "⬅️ Дехар дукхахь",
        "open_payment": "ТӀетоха аьш йоцу",
        "check_payment": "ДӀахьахь тӀетоха, бахьара ✅",
        "pending": "Хьо цу! ТӀетоха хьалх бац, подписка автот йоцуш кхин цуьнан секундийнахь.\nМа бац — «Бахьара» батта.",
        "no_active": "ХӀинца йоь дӀайа активна подписка. ТӀетоха хийца — тӀехьа хьажа минут вәшна, дац «Бахьара».",
        "active_now": "ГӀалгIай! ✨ Подписка активна.",
    },
}
