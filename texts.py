...
STORY_INTENT = {
    "ru": ["сказку", "сказка", "рассказ", "байку", "историю на ночь"],
    "uk": ["казку", "казка", "оповідання", "історію на ніч"],
    "md": ["poveste", "basm", "povești", "istorie de noapte"],
    "be": ["казку", "казка", "апавяданне"],
    "kk": ["ертегі", "әңгіме", "ұйқы алдында"],
    "kg": ["жомок", "аңгеме", "уктоочу окуя"],
    "hy": ["հեքիաթ", "պատմություն", "քնելուց առաջ"],
    "ka": ["ზღაპარი", "ისტორია", "დაძინებამდე"],
    "ce": ["хьикьа", "истори", "хьалхар кхета"],
    "en": ["story", "bedtime", "fairy tale", "tale"],
}
