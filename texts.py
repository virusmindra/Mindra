...
GH_TEXTS = {
    "ru": {
        ...
        "btn_list_goals": "📋 Список целей",
        "btn_add_habit": "➕ Добавить привычку",
        "btn_list_habits": "📋 Список привычек",
        "back": "◀️ Меню",
        "goals_title": "🎯 Твои цели:",
        "habits_title": "🌱 Твои привычки:",
        "goals_empty": "Пока нет целей. Нажми «➕ Добавить цель».",
    ...
    "uk": {
        ...
        "btn_list_goals": "📋 Список цілей",
        "btn_add_habit": "➕ Додати звичку",
        "btn_list_habits": "📋 Список звичок",
        "back": "◀️ Меню",
    ...
    "md": {
        ...
        "btn_add_goal": "➕ Adaugă obiectiv",
        "btn_list_goals": "📋 Lista obiectivelor",
        "btn_add_habit": "➕ Adaugă obicei",
        "btn_list_habits": "📋 Lista obiceiurilor",
        "back": "◀️ Meniu",
        "goals_title": "🎯 Obiectivele tale:",
        "habits_title": "🌱 Obiceiurile tale:",
        "goals_empty": "Deocamdată nu ai obiective. Apasă „➕ Adaugă obiectiv”.",
    ...
    "be": {
        ...
        "btn_add_goal": "➕ Дадаць мэту",
        "btn_list_goals": "📋 Спіс мэт",
        "btn_add_habit": "➕ Дадаць звычку",
        "btn_list_habits": "📋 Спіс звычак",
        "back": "◀️ Меню",
        "goals_title": "🎯 Твае мэты:",
        "habits_title": "🌱 Твае звычкі:",
        "goals_empty": "Пакуль няма мэт. Націсні «➕ Дадаць мэту».",
    ...
    "kk": {
        ...
        "btn_list_goals": "📋 Мақсаттар тізімі",
        "btn_add_habit": "➕ Әдет қосу",
        "btn_list_habits": "📋 Әдеттер тізімі",
        "back": "◀️ Мәзір",
        "goals_title": "🎯 Сіздің мақсаттарыңыз:",
        "habits_title": "🌱 Сіздің әдеттеріңіз:",
        "goals_empty": "Әзірге мақсаттар жоқ. «➕ Мақсат қосу» батырмасын басыңыз.",
    ...
    "kg": {
        ...
        "btn_add_goal": "➕ Максат кошуу",
        "btn_list_goals": "📋 Максаттар тизмеси",
        "btn_add_habit": "➕ Адат кошуу",
        "btn_list_habits": "📋 Адаттар тизмеси",
        "back": "◀️ Меню",
        "goals_title": "🎯 Сенин максаттарың:",
        "habits_title": "🌱 Сенин адаттарың:",
        "goals_empty": "Азырынча максаттар жок. «➕ Максат кошуу» бас.",
    ...
    "hy": {
        ...
        "btn_add_goal": "➕ Ավելացնել նպատակ",
        "btn_list_goals": "📋 Նպատակների ցանկ",
        "btn_add_habit": "➕ Ավելացնել սովորություն",
        "btn_list_habits": "📋 Սովորությունների ցանկ",
        "back": "◀️ Մենյու",
        "goals_title": "🎯 Քո նպատակները․",
        "habits_title": "🌱 Քո սովորությունները․",
        "goals_empty": "Դեռ նպատակներ չկան։ Սեղմիր «➕ Ավելացնել նպատակ».",
        "habits_empty": "Դեռ սովորություններ չկան։ Սեղմիր «➕ Ավելացնել սովորություն».",
    ...
    "ka": {
        ...
        "btn_list_goals": "📋 მიზნების სია",
        "btn_add_habit": "➕ ჩვევის დამატება",
        "btn_list_habits": "📋 ჩვევების სია",
        "back": "◀️ მენიუ",
        "goals_title": "🎯 შენი მიზნები:",
        "habits_title": "🌱 შენი ჩვევები:",
        "goals_empty": "ჯერ მიზნები არ გაქვს. დააჭირე «➕ მიზნის დამატება».",
    ...
    "en": {
        ...
        "btn_list_goals": "📋 Goals list",
        "btn_add_habit": "➕ Add habit",
        "btn_list_habits": "📋 Habits list",
        "back": "◀️ Menu",
...
help_texts = {
    ...
    "uk": (
        ...
        "🎯 /goal — поставити особисту ціль\n"
        "🏆 /goals — список твоїх цілей\n"
        "🌱 /habit — додати звичку\n"
        "📋 /habits — список твоїх звичок\n"
    ...
    "md": (
        ...
        "🎯 /goal — stabilește un obiectiv personal\n"
        "🏆 /goals — lista obiectivelor tale\n"
        "🌱 /habit — adaugă un obicei\n"
        "📋 /habits — lista obiceiurilor tale\n"
        "📌 /task — sarcina zilei\n"
        "✉️ /feedback — trimite feedback\n"
        "⏰ /remind — amintește despre obiectiv\n"
    ...
    "be": (
        ...
        "🎯 /goal — паставіць асабістую мэту\n"
        "🏆 /goals — спіс тваіх мэт\n"
        "🌱 /habit — дадаць звычку\n"
        "📋 /habits — спіс тваіх звычак\n"
    ...
    "kg": (
        ...
        "🎯 /goal — жеке максат коюу\n"
        "🏆 /goals — максаттар тизмеси\n"
        "🌱 /habit — адат кошуу\n"
        "📋 /habits — адаттар тизмеси\n"
        "📌 /task — күндүн тапшырмасы\n"
        "✉️ /feedback — пикир жөнөтүү\n"
        "⏰ /remind — максат тууралуу эскертүү\n"
    ...
    "ce": (
        ...
        "🎯 /goal — декъашхо цуьнан хIаттар\n"
        "🏆 /goals — цуьнан хIаттар тIед\n"
        "🌱 /habit — дийцар дIадайе\n"
        "📋 /habits — дийцар тIед\n"
        "📌 /task — деьйна йола\n"
        "✉️ /feedback — отзыв йола\n"
        "⏰ /remind — хIаттар хIоккхар\n"
