...
MENU_TEXTS = {
    "ru": {
        ...
        "open": "Открыть",
        "summary": (
            "• Движок озвучки: *{engine}*\n"
            "• Сон-звук: *{sleep_sound}*, {dur} мин, {gain} dB\n"
            "• Премиум: *{premium}*{until}"
        ),
        "premium_yes": "активен",
        "premium_no": "нет",
        "until_fmt": " (до {dt})",
        "premium_title": "💎 Премиум",
        "premium_buy": "Оформить Mindra+",
        "premium_days": "Сколько дней осталось?",
        "invite": "Пригласить друга (+7 дней)",
        "lang": "🌐 Язык",
        "tz": "🕒 Часовой пояс",
        "choose_lang": "Выберите язык:",
        "help_text": "Здесь вы можете управлять озвучкой, звуками сна, премиумом и профилем.",
    },
    "uk": {
        "title": "🏠 Головне меню",
        "voice": "🎧 Озвучення",
        ...
        "open": "Відкрити",
        "summary": (
            "• Двигун озвучення: *{engine}*\n"
            "• Сон-звук: *{sleep_sound}*, {dur} хв, {gain} dB\n"
            "• Преміум: *{premium}*{until}"
        ),
        "premium_yes": "активний",
        "premium_no": "ні",
        "until_fmt": " (до {dt})",
        "premium_title": "💎 Преміум",
        "premium_buy": "Оформити Mindra+",
        "premium_days": "Скільки днів лишилось?",
        "invite": "Запросити друга (+7 днів)",
        "lang": "🌐 Мова",
        "tz": "🕒 Часовий пояс",
        "choose_lang": "Оберіть мову:",
        "help_text": "Тут можна керувати озвученням, звуками сну, преміумом і профілем.",
    },
    "md": {
        "title": "🏠 Meniu principal",
        "voice": "🎧 Voce",
        "sleep": "😴 Sunete de somn",
        "story": "📖 Poveste",
        "premium": "💎 Premium",
        "profile": "👤 Profil",
        "help": "❓ Ajutor",
        ...
        "summary": (
            "• Motor voce: *{engine}*\n"
            "• Sunet somn: *{sleep_sound}*, {dur} min, {gain} dB\n"
            "• Premium: *{premium}*{until}"
        ),
        "premium_yes": "activ",
        "premium_no": "nu",
        "until_fmt": " (până la {dt})",
        "premium_title": "💎 Premium",
        "premium_buy": "Activează Mindra+",
        "premium_days": "Câte zile au rămas?",
        "invite": "Invită un prieten (+7 zile)",
        "lang": "🌐 Limbă",
        "tz": "🕒 Fus orar",
        "choose_lang": "Alege limba:",
        "help_text": "Aici poți gestiona vocea, sunetele de somn, premium și profilul.",
    },
    "be": {
        "title": "🏠 Галоўнае меню",
        "voice": "🎧 Агучванне",
        ...
        "open": "Адкрыць",
        "summary": (
            "• Рухавік агучвання: *{engine}*\n"
            "• Гук сну: *{sleep_sound}*, {dur} хв, {gain} dB\n"
            "• Прэміум: *{premium}*{until}"
        ),
        "premium_yes": "актыўны",
        "premium_no": "не",
        "until_fmt": " (да {dt})",
        "premium_title": "💎 Прэміум",
        "premium_buy": "Аформіць Mindra+",
        "premium_days": "Колькі дзён засталося?",
        "invite": "Запрасіць сябра (+7 дзён)",
        "lang": "🌐 Мова",
        "tz": "🕒 Часавы пояс",
        "choose_lang": "Абярыце мову:",
        "help_text": "Тут вы можаце кіраваць агучваннем, гукамі сну, прэміумам і профілем.",
    },
    "kk": {
        "title": "🏠 Бас мәзір",
        "voice": "🎧 Дыбыс",
        "sleep": "😴 Ұйқы дыбыстары",
        "story": "📖 Ертегі",
        "premium": "💎 Премиум",
        "profile": "👤 Профиль",
        "help": "❓ Көмек",
        ...
        "open": "Ашу",
        "summary": (
            "• Дыбыс қозғалтқышы: *{engine}*\n"
            "• Ұйқы дыбысы: *{sleep_sound}*, {dur} мин, {gain} dB\n"
            "• Премиум: *{premium}*{until}"
        ),
        "premium_yes": "белсенді",
        "premium_no": "жоқ",
        "until_fmt": " (дейін {dt})",
        "premium_title": "💎 Премиум",
        "premium_buy": "Mindra+ рәсімдеу",
        "premium_days": "Қанша күн қалды?",
        "invite": "Дос шақыру (+7 күн)",
        "lang": "🌐 Тіл",
        "tz": "🕒 Уақыт белдеуі",
        "choose_lang": "Тілді таңдаңыз:",
        "help_text": "Мұнда дыбысты, ұйқы дыбыстарын, премиумды және профильді басқара аласыз.",
    },
    "kg": {
        "title": "🏠 Башкы меню",
        "voice": "🎧 Үн",
        ...
        "open": "Ачу",
        "summary": (
            "• Үн кыймылдаткычы: *{engine}*\n"
            "• Уктатма үн: *{sleep_sound}*, {dur} мин, {gain} dB\n"
            "• Премиум: *{premium}*{until}"
        ),
        "premium_yes": "активдүү",
        "premium_no": "жок",
        "until_fmt": " (дейре {dt})",
        "premium_title": "💎 Премиум",
        "premium_buy": "Mindra+ кошуу",
        "premium_days": "Канча күн калды?",
        "invite": "Дос чакыруу (+7 күн)",
        "lang": "🌐 Тил",
        "tz": "🕒 Саат алкагы",
        "choose_lang": "Тилди тандаңыз:",
        "help_text": "Бул жерде үн, уктатма үндөр, премиум жана профильди башкарыңыз.",
    },
    "hy": {
        ...
        "open": "Բացել",
        "summary": (
            "• Ձայնավորման շարժիչ: *{engine}*\n"
            "• Քնի ձայն: *{sleep_sound}*, {dur} րֆ, {gain} dB\n"
            "• Պրեմիում՝ *{premium}*{until}"
        ),
        "premium_yes": "ակտիվ",
        "premium_no": "ոչ",
        "until_fmt": " (մինչև {dt})",
        "premium_title": "💎 Պրեմիում",
        "premium_buy": "Միացնել Mindra+",
        "premium_days": "Քանի օր է մնացել?",
        "invite": "Հրավիրել ընկերոջ (+7 օր)",
        "lang": "🌐 Լեզու",
        "tz": "🕒 Ժամային գոտի",
        "choose_lang": "Ընտրեք լեզուն․",
        "help_text": "Կառավարեք ձայնավորումը, քնի ձայները, պրեմիումը և պրոֆիլը։",
    },
    "ka": {
        "title": "🏠 მთავარი მენიუ",
        "voice": "🎧 გახმოვანება",
        ...
        "open": "გახსნა",
        "summary": (
            "• გახმოვანების ძრავი: *{engine}*\n"
            "• ძილის ხმა: *{sleep_sound}*, {dur} წთ, {gain} dB\n"
            "• პრემიუმი: *{premium}*{until}"
        ),
        "premium_yes": "აქტიურია",
        "premium_no": "არა",
        "until_fmt": " (მდე {dt})",
        "premium_title": "💎 პრემიუმი",
        "premium_buy": "Mindra+ გაფორმება",
        "premium_days": "რამდენი დღე დარჩა?",
        "invite": "მოიწვინე მეგობარი (+7 დღე)",
        "lang": "🌐 ენა",
        "tz": "🕒 დროის სარტყელი",
        "choose_lang": "აირჩიეთ ენა:",
        "help_text": "აქ მართეთ გახმოვანება, ძილის ხმები, პრემიუმი და პროფილი.",
    },
    "ce": {
        "title": "🏠 Къоман меню",
        "voice": "🎧 АгӀо",
        "sleep": "😴 Дехарийн хийра",
        "story": "📖 Хьикьа",
        "premium": "💎 Премиум",
        "profile": "👤 Профиль",
        "help": "❓ Доллацам",
        ...
        "summary": (
            "• АгӀо мотт: *{engine}*\n"
            "• Дехарийн хийра: *{sleep_sound}*, {dur} мин, {gain} dB\n"
            "• Премиум: *{premium}*{until}"
        ),
        "premium_yes": "активен",
        "premium_no": "йоцуш",
        "until_fmt": " (кхана {dt} хьоьлла)",
        "premium_title": "💎 Премиум",
        "premium_buy": "Mindra+ юкъа",
        "premium_days": "Мачу дийна да?",
        "invite": "Дуьз дина (+7 дийна)",
        "lang": "🌐 Мотт",
        "tz": "🕒 Хьалхар",
        "choose_lang": "Мотт хьажар:",
        "help_text": "Дерриг агӀо, дехарийн хийраш, премиум, профиль.",
    },
    "en": {
        "title": "🏠 Main menu",
        "voice": "🎧 Voice",
        ...
        "summary": (
            "• TTS engine: *{engine}*\n"
            "• Sleep sound: *{sleep_sound}*, {dur} min, {gain} dB\n"
            "• Premium: *{premium}*{until}"
        ),
        "premium_yes": "active",
        "premium_no": "no",
        "until_fmt": " (until {dt})",
        "premium_title": "💎 Premium",
        "premium_buy": "Get Mindra+",
        "premium_days": "Days left?",
        "invite": "Invite a friend (+7d)",
        "lang": "🌐 Language",
        "tz": "🕒 Timezone",
        "choose_lang": "Choose language:",
        "help_text": "Manage voice, sleep sounds, premium and profile here.",
    },
}
