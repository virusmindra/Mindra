...
STORY_INTENT = {
    ...
    "md": [r"\bpovest", r"\bpoveste", r"\bistorie", r"\bbasm"],
    "be": [r"\bказк", r"\bгістор"],
    "kk": [r"\bертег", r"\bхикая", r"\bәңгіме"],
    "kg": [r"\bжомок", r"\bоку .*жомок"],
    "hy": [r"\bհեքիաթ", r"\bպատմու"],
    "ka": [r"\bზღაპარ", r"\bისტორი"],
    "ce": [r"\bлегенд", r"\bистора"],
    "en": [r"\bstory\b", r"\bfairy", r"\bbedtime", r"\btell.*story"],
}
