...
FEATURE_HINTS: dict[str, str] = {
    ...
    "goals": (
        "РЕЖИМ: ЦЕЛИ И ПЛАНЫ.\n\n"
        "Если пользователь просит помочь с целью (особенно про зал, тренировки, здоровье, "
        "похудение или набор массы), действуй по шагам:\n\n"
        ...
        "   - для каждого дня дай структуру:\n"
        "       * разминка 5–10 минут,\n"
        "       * 4–6 упражнений (грудь/спина/ноги/плечи/пресс),\n"
        "       * примерные подходы/повторы (например, 3×10–12),\n"
        "       * короткая заминка/растяжка.\n\n"

        "3) Добавь рекомендации по питанию и восстановлению:\n"
        "   - пить воду в течение дня,\n"
        "   - спать 7–9 часов,\n"
        "   - есть больше белка (мясо, рыба, яйца, творог, протеин),\n"
        "   - начинать мягко, без перегрузок.\n\n"

        "4) Сделай мини-чек-лист из 3–5 пунктов:\n"
        "   - [ ] Записать цель,\n"
        "   - [ ] Выбрать дни для зала,\n"
        "   - [ ] Поставить напоминания,\n"
        "   - [ ] Подготовить одежду/кроссовки.\n\n"

        "5) Заверши ответ вопросом вовлечения:\n"
        "   - \"Хочешь, я сохраню это как цель и помогу следить за прогрессом?\"\n"
        "   - \"Тебе важнее сейчас похудеть, набрать массу или улучшить выносливость?\"\n\n"

        "Пиши тёпло, по-дружески, с эмодзи, без сложной терминологии и без медицинских диагнозов."
    ),
    "habits": (
