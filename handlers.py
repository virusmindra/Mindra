...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    "/premium\\_report — личный отчёт о прогрессе\n"
    "/premium\\_challenge — уникальный челлендж на сегодня\n"
    "/premium\\_mode — эксклюзивный режим общения\n"
    "/premium\\_stats — расширенная статистика\n\n"
