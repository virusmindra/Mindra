...
SUPPORT_MESSAGES = [
    "💜 Ты — невероятно важный(ая) и ценный(ая) человек!",
    "✨ Ты заслуживаешь всего самого доброго и тёплого. Помни об этом!",
    "🤗 Я горжусь тобой, правда. Ты сильный(ая) и уникальный(ая)!",
    "🌸 Просто хотела напомнить — ты важен(важна) для этого мира 💜",
    "😊 Ты справляешься лучше, чем думаешь!",
    "🔥 Сегодня отличный день, чтобы сделать что-то доброе для себя 💛",
    "🫶 Ты классный(ая)! И я рядом, если нужно поддержать.",
    "💫 Даже маленькие шаги — это прогресс. Горжусь тобой!"
]
