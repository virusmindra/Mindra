...
DAILY_TASKS = ([
    ...
    "💌 Напиши сообщение человеку, с которым давно не говорил(а), и просто спроси, как он(а).",
    "🌞 Утром скажи доброе слово первому встречному — пусть твой день начнётся с позитива!",
    "🍀 Помоги сегодня кому‑то мелочью: придержи дверь, уступи место, подай вещь. Сделай добро просто так.",
    "🤗 Похвали коллегу или друга за что‑то, что он(а) сделал(а) хорошо. Пусть узнает, что ты ценишь его(её).",
    "👂 Задай сегодня кому‑то глубокий вопрос: «А что тебя делает счастливым(ой)?» и послушай ответ.",
    "🎈 Подари сегодня кому‑то улыбку и скажи: «Ты классный(ая)!» — это не требует денег, но даёт тепло.",
    ...
    "🌟 Если увидишь красивый наряд или стиль у кого‑то — скажи об этом прямо, пусть день человека станет лучше!",
    ...
    "☕ Купи кофе для человека, который стоит за тобой в очереди. Просто так. И наблюдай за его реакцией!",
