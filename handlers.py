...
IDLE_MESSAGES = [
    ...
    "🌱 А как там твоя цель? Я верю, что ты ближе, чем думаешь.",
    "🔥 Помнишь, как ты говорил(а) про свою цель? Что-то внутри говорит мне — ты на верном пути.",
    "📌 Я тут подумала: может, пора добавить ещё одну маленькую привычку? 😉",
    "💡 Я вспомнила одну мысль, которую хочу тебе рассказать… Напиши мне, если интересно 😏",
    "🔮 У меня для тебя есть предсказание. Только для тебя. Загляни 🙃",
    "🎁 Угадай, что? Я придумала кое-что новое специально для тебя.",
    "🤍 Просто хотела напомнить — ты не один(а), я рядом.",
    "🍵 Если бы могла, я бы сейчас заварила тебе чай. Но хотя бы могу спросить — ты в порядке?",
